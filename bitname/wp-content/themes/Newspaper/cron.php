...
$arraylist = array(
    ...
    API_USGS_ENDPOINT_EARTHQUAKE_REALTIME . "&starttime=1998-12-01&endtime=1999-01-01",
    API_USGS_ENDPOINT_EARTHQUAKE_REALTIME . "&starttime=1998-11-01&endtime=1998-12-01",
    API_USGS_ENDPOINT_EARTHQUAKE_REALTIME . "&starttime=1998-10-01&endtime=1998-11-01",
    API_USGS_ENDPOINT_EARTHQUAKE_REALTIME . "&starttime=1998-09-01&endtime=1998-10-01",
    API_USGS_ENDPOINT_EARTHQUAKE_REALTIME . "&starttime=1998-08-01&endtime=1998-09-01",
    API_USGS_ENDPOINT_EARTHQUAKE_REALTIME . "&starttime=1998-07-01&endtime=1998-08-01",
    API_USGS_ENDPOINT_EARTHQUAKE_REALTIME . "&starttime=1998-06-01&endtime=1998-07-01",
    API_USGS_ENDPOINT_EARTHQUAKE_REALTIME . "&starttime=1998-05-01&endtime=1998-06-01",
    API_USGS_ENDPOINT_EARTHQUAKE_REALTIME . "&starttime=1998-04-01&endtime=1998-05-01",
    API_USGS_ENDPOINT_EARTHQUAKE_REALTIME . "&starttime=1998-03-01&endtime=1998-04-01",
    API_USGS_ENDPOINT_EARTHQUAKE_REALTIME . "&starttime=1998-02-01&endtime=1998-03-01",
    API_USGS_ENDPOINT_EARTHQUAKE_REALTIME . "&starttime=1998-01-01&endtime=1998-02-01",
            ...
            if ($wunderground->dbConnect) {
                ...
                if ($EQCheckRow->num_rows == 0) {
                    ...
                    $sqlInsertEQ = "INSERT INTO USGSEarthquake(
                                  ...
                                  object) 
                                  VALUES (
                                  '" . $wunderground->dbConnect->real_escape_string($earthquake->getId()) . "',
