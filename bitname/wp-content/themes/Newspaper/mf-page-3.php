...
<div class="template-download downlordsec3">
    <section id="cardsec-top">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <h2 style="color:#000;">Confirm or Modify Your Details Below Then <span>DOWNLOAD INSTANTLY</span>!</h2>
                </div>
            </div>
        </div>
    </section>
    <section id="emergency-contact-form">
        <form id="userinfo" class="contactpageform">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="form-textsec ec-formsec-user">
                            <div class="input-group" style="background:#fff !important;">
                                <input id="name" type="text" class="form-control" name="name" placeholder="Enter Your Full Name"><span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            </div>
                            <div class="input-group phonenumber" style="background:#fff !important;">
                                <input id="email" type="email" class="form-control" name="email" placeholder="Enter Your Email Address"><span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="emergency-contact-form" style="padding-top:20px;">
        <form id="completed-contact2" class="contactpageform">
            <div class="container ec-formsec">
                <div class="row">
                    <div class="col-xs-12">
