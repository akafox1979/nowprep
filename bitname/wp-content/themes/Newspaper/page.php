...
<style>
    ...
    #form-sec-home {
        background: #c90017;
        border: #000 2px solid;
        padding-bottom: 13px;margin-top: 30px;
    }
    ...
    section#sales-sec2 button,#emergency-contact-form button,section#cardsec-top button, a.complete-order-btn, section#order-sec1 button,div#dwnc a {
        background: #066102;
    ...
    #emergency-contact-form button:hover, a.complete-order-btn:hover, section#order-sec1 button:hover {
        background: #58d05d;
        background: -moz-linear-gradient(top, #066102 1%, #58d05d 100%);
        background: -webkit-linear-gradient(top, #066102 1%, #58d05d 100%);
        background: linear-gradient(to bottom, #066102 1%, #58d05d 100%);
    ...
    .form-textsec span {text-align: left; font-size:13px;}
    ...
    @media screen and (min-device-width:300px) and (max-device-width: 767px){
        ...
        form.repeater-contacts-bottom{padding:11px 10px;}
        ...
        <section id="cardsec-top">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6"><img src="<?php echo str_replace('http://','https://',get_template_directory_uri()); ?>/assets/ecc/images/widewhitereflective.png" class="v-card img-responsive"> <img src="<?php echo str_replace('http://','https://',get_template_directory_uri()); ?>/assets/ecc/images/arrow.png" class="tophome img-responsive"></div>
                    <div class="col-sm-6">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="money-bag-sec">
                            <img src="http://nowprep.com/wp-content/uploads/home-card.jpg" class="img-responsive">
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-6 mob">
                        <div class="money-bag-sec">
                            <img src="http://nowprep.com/wp-content/uploads/home-card1.jpg" class="img-responsive">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="money-bag-sec">
                        ...
                        <div class="col-xs-12">
                            <div class="form-textsec">
                                ...
                                <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input id="name" type="text" class="form-control" name="name" placeholder="Enter Primary Contact's Name*">
                                </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="form-textsec">
                                <h3>In Case of Emergency, Please Contact...</h3>
                                <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input id="name" type="text" class="form-control" name="name" placeholder="Enter Secondary Contact's Name*">
                                </div>
                                <div class="input-group phonenumber"> <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                                    <input id="email" type="email" class="form-control" name="email" placeholder="Email">
                                </div>
                        ...
                        <div style="min-height:300px;">
                            ...
                            <div class="process_section loading_content">
                                ...
                                <span class="step step_2"><i class="fa fa-spinner fa-spin process"></i><i
                                        class="fa fa-check complete"></i></span>
                                <br>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="form-textsec">
                                            ...
                                            <div class="nameful">
                                                <span class="glyphicon glyphicon-phone-alt" aria-hidden="true"></span><strong>Phone</strong><span class="mainphone d-phone"></span>
                                            </div>
    ...
    <div class="template-sales">
        ...
        <section id="sales-sec2">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <h4><strong>Congratulations</strong> on completing your emergency contact cards!</h4>
                        <p>Before you print your cards, please take advantage of this Limited Time Offer to get the Emergency Contact Card Premium Package! It’s a simple & affordable way to better prepare.</p>
                        <a href="#order-sec1">
                            <button type="button" class="sales-btn btn-info btn-lg"> Order Now!</button>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <section id="sales-sec4">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <p class="sec4text">With our reliance on technology at an all-time high, most individuals are completely unprepared when their phones break or if they had to survive without electricity.  This simple solution allows you to keep a physical record of your most vital info with you at all times.</p>
                        <p class="sec4text">Together, let’s make preparation a priority and invest in our safety!</p>
                        <p class="sec4text">Remember with these simple and portable cards, you’ll already be 90% more prepared for the unexpected than most Americans.</p>
                    </div>
                </div>
            </div>
        </section>
