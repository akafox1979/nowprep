...
<head>
    ...
    <title>NowPrep</title>
    <link rel=icon href=https://nowprep.com/wp-content/uploads/NowPrep_CheckFavicon_16x16d.png sizes="16x16" type="image/png">
...
<style>
    ...
    form.repeater-contacts-bottom {
        background: #c90017;
        border-radius: 15px;
        padding: 0px 30px 15px;margin-top: 20%;
    ...
    .twoform {
        ...
        background-size: cover !important;padding-top:30px !important;
    }
    img.tophome {
        width: 80px;
        float: right;
    ...
    #form-sec-home form .input-group input {
        font-size: 18px;
        height:43px;
        line-height:36px;padding-top:0px;padding-bottom:0px;
    }
    .asseen-logos img {
        width: 16%;
        padding: 3px;
    ...
    section#sales-sec12 h4 span{color: #e32726;}
    ...
    section#sales-sec2 {
        background: #015bbb;
        padding: 10px 0px;margin-bottom: 25px;
    }
    ...
    .congr-text h2 {text-align: center;color: #333333;font-weight: 600;font-size: 28px;padding-bottom: 21px;}
    .congr-text h2 span {color: #ea201e;}
    .congr-text p {text-align: center;color: #000;font-weight: 600;font-size: 22px;padding-bottom: 21px;}
    .congr-text hr {border: #000000 1px dotted;margin-top: 0px;}
    .below-cont-text h3 {color: #000;font-weight: 600;font-size: 26px;padding-bottom: 21px;}
    .below-cont-text ul {list-style: none;}
    .below-cont-text ul li {padding-bottom: 18px;font-size: 18px;font-weight: 600;}
    .below-cont-text ul li span {padding-left: 13px;font-size: 23px;background: url(http://nowprep.com/wp-content/uploads/generate-icon.png); background-repeat: no-repeat;list-style: none;padding-right: 20px;padding-top: 2px;background-size: 41px;color: #fff;line-height: 24px;padding-bottom: 5px;}
    span.bonus-text {font-size: 9px !important;padding-bottom: 21px !important;padding-top: 14px !important;padding-left: 5px !important;font-style: italic;padding-right: 10px !important;}
    .below-cont-text h4 {text-align: right;font-style: italic;font-weight: 800;font-size: 19px;}
    .congr-text p u {color: #e32726;}
    section.generate-download-sec .ec-formsec {padding: 0px 13px 13px;}
    .form-textsec span {text-align: left; font-size:13px; height:12px;}
    ...
    @media screen and (min-device-width:768px){
        ...
        .contactpageform .input-group input::-webkit-input-placeholder {font-size: 17px;}
        .contactpageform .input-group input::-moz-placeholder {font-size: 17px;}
        .contactpageform .input-group input:-ms-input-placeholder {font-size: 17px;}
        .contactpageform .input-group input:-moz-placeholder {font-size: 17px;}
        .contactpageform .input-group input{font-size:17px;}
    ...
    @media screen and (min-device-width:300px) and (max-device-width: 767px){
        ...
        #form-sec-home form button{padding: 8px 20px;}
        footer {
            margin-top: 20px;
        }
        section#sales-sec12 h3 {
        ...
        form.repeater-contacts-top {
            padding-bottom: 12px;padding: 1px 10px 10px !important;
        }
        .nameful2 {
            width: 100%;
        }
        ...
        form.repeater-contacts-bottom{padding:11px 10px;margin-top: 3%;}
        ::-webkit-input-placeholder {font-size: 15px;}
        ::-moz-placeholder {font-size: 15px;}
        :-ms-input-placeholder {font-size: 15px;}
        :-moz-placeholder {font-size: 15px;}
    ...
    #form-sec-home {
        background: #c90017;
        border-radius: 15px;
        padding: 0px 30px 15px;-webkit-box-shadow: 0px 0px 10px 0px rgba(0,0,0,0.75);
        -moz-box-shadow: 0px 0px 10px 0px rgba(0,0,0,0.75);
        box-shadow: 0px 0px 10px 0px rgba(0,0,0,0.75);
    }
    ...
    div#order-sec1 {
        float: left;
        border: #bfbfbf 4px solid;border-radius:10px;
    }
    .step1-form {
        padding: 0px 10px;
    }
    ...
    @media screen and (min-width:767px){
        ...
        section#cardsec-top h5 span{display: none;}
        section#cardsec-top h5 i{display: block !important;}
    }
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <div class="sec1leftsec">
                            <img src="https://nowprep.com/wp-content/uploads/homepageimgtop.png" class="newsec1img img-responsive" style="z-index: 99;position: relative;top: 50px;"> <img src="<?php echo str_replace('http://','https://',get_template_directory_uri()); ?>/assets/ecc/images/arrow.png" class="tophome img-responsive">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6 mob">
                        <div class="money-bag-sec"> <img src="https://nowprep.com/wp-content/uploads/home-right-card.png" class="img-responsive"> </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row childw" style="padding-top: 89px;">
                    <div class="col-sm-6">
                        <div class="money-bag-sec childme"> <img src="https://nowprep.com/wp-content/uploads/childman.png" class="img-responsive"> </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="customer-say">
                            ...
                            <div class="testmonila-footer">
                                <div class="pertestmo1"><img src="https://nowprep.com/wp-content/uploads/richard-d.png" class="img-responsive"></div>
                                <div class="pertestmo1"><img src="https://nowprep.com/wp-content/uploads/david-n.png" class="img-responsive"></div>
                                <div class="pertestmo1"><img src="https://nowprep.com/wp-content/uploads/barbara.png" class="img-responsive"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <form accept-charset="UTF-8" action="https://vp389.infusionsoft.com/app/form/process/8cd6bd899cd77d9377bf2cee1e2efab4" class="infusion-form repeater-contacts-bottom" id="inf_form_8cd6bd899cd77d9377bf2cee1e2efab4" method="POST">
                            <div class="creatingcard">
                                <h4>To begin creating YOUR card, just enter your name and email below</h4>
                            </div>
                            <input name="inf_form_xid" type="hidden" value="8cd6bd899cd77d9377bf2cee1e2efab4" />
                            <input name="inf_form_name" type="hidden" value="Step #1" />
                            <input name="infusionsoft_version" type="hidden" value="1.68.0.90" />
                            <div class="infusion-field input-group">
                                <input class="infusion-field-input-container form-control" id="inf_field_FirstName" name="inf_field_FirstName" type="text" placeholder="Enter Your Full Name"/>
                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            </div>
                            <div class="infusion-field input-group">
                                <input class="infusion-field-input-container form-control" id="inf_field_Email" name="inf_field_Email" type="text" placeholder="Enter Your Email Address"/>
                                <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                            </div>
                            <div class="infusion-submit">
                                <button type="submit" class="btn-primary btn-lg btn-block">YES! Download My FREE Emergency Card INSTANTLY!</button>
                            </div>
                            <p class="locksec"><i class="glyphicon glyphicon-lock"></i> We respect your privacy</p>
                        </form>
                            ...
                            <div class="ec-formsec">
                                ...
                                <div class="form-textsec">
                                    ...
                                    <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input id="name" type="text" class="form-control" name="name" placeholder="Primary Contact's Name*">
                                    </div>
                        ...
                        <form class="contact-form-second">
                            ...
                            <div class="ec-formsec">
                                ...
                                <div class="form-textsec">
                                    <h3>In Case of Emergency, Please Contact...</h3>
                                    <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input id="name" type="text" class="form-control" name="name" placeholder="Secondary Contact's Name*">
                                    </div>
                                    <div class="input-group phonenumber"> <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                                        <input id="email" type="email" class="form-control" name="email" placeholder="Email">
                                    </div>
                                ...
                                <div class="aft_complete">
                                    <div id="dwnc" style="cursor: pointer;"><a class="step_button steppad step_button_1 next">Download
                                        ...
                                        <div class="card-new">
                                            ...
                                            <img id="emergency_card_img" src="" style="width: 1275px;height: 1650px;margin: 0px 0px;display:none;" /> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-7">
                        <div class="payment-contantsec">
                            <div class="contantimg"><img src="https://nowprep.com/wp-content/uploads/salescard.jpg" class="img-responsive"></div>
                            <div class="listline">
                                <ul>
                        ...
                        <div id="order-sec1">
                            ...
                            <form id="order" class="repeater-checkout-pass">
                                ...
                                <div class="paymentsec">
                                    ...
                                    <div class="cardlogo-lofo"><img src="<?php echo str_replace('http://','https://',get_template_directory_uri()); ?>/assets/ecc/images/cardlogo.png" class="cardlogo img-responsive"></div>
                                    <div class="step1-form">
                                        ...
                                        <div class="input-group cvv">
                                            ...
                                            <div class="tooltip">What is this? <span class="tooltiptext"><img src="https://nowprep.com/wp-content/uploads/cvvimg.jpg" class="img-responsive"></span></div>
                                        </div>
                                    </div>
                                </div>
...
">
                                    ...
                                    <div class="col-xs-12"><img src="https://nowprep.com/wp-content/uploads/security-logo.png" class="security-logo img-responsive"></div>
                                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("form.repeater-contacts-top").submit(function(){
            if($(this).valid()) {
                $(".template-index").hide();
                $(window).scrollTop(0);
