...
//$ii = 2017;
    ...
    //SELECT *,dt_time AS times FROM usgsearthquake WHERE (dt_time BETWEEN '10/01/2017' AND '11/30/2017') ORDER BY dt_time DESC;
...
//SELECT DISTINCT YEAR(dt_time), MONTH(dt_time),count(*) FROM usgsearthquake GROUP BY YEAR(dt_time), MONTH(dt_time) ORDER BY YEAR(dt_time), MONTH(dt_time);
                ...
                if (true) {
                    ...
                    if (true) { //($EQCheckRow->num_rows == 0) {
                        ...
                        $sqlInsertEQ = "INSERT INTO usgsearthquake(
                                  ...
                                  '" . esc_sql($earthquake->getTitle()) . "',
                                  '" . esc_sql($earthquake->getType()) . "',
                                  '" . esc_sql($earthquake->getMagType()) . "',
                                  '" . esc_sql($earthquake->getGap()) . "',
                                  '" . esc_sql($earthquake->getRms()) . "',
                                  '" . esc_sql($earthquake->getDmin()) . "',
                                  '" . esc_sql($earthquake->getNst()) . "',
                                  '" . esc_sql($earthquake->getTypes()) . "',
                                  '" . esc_sql($earthquake->getSources()) . "',
                                  '" . esc_sql($earthquake->getIds()) . "',
                                  '" . esc_sql($earthquake->getCode()) . "',
                                  '" . esc_sql($earthquake->getNet()) . "',
                                  '" . esc_sql($earthquake->getSig()) . "',
                                  '" . esc_sql($earthquake->getTsunami()) . "',
                                  '" . esc_sql($earthquake->getStatus()) . "',
                                  '" . esc_sql($earthquake->getAlert()) . "',
                                  '" . esc_sql($earthquake->getMmi()) . "',
                                  '" . esc_sql($earthquake->getCdi()) . "',
                                  '" . esc_sql($earthquake->getFelt()) . "',
                                  '" . esc_sql($earthquake->getDetail()) . "',
                                  '" . esc_sql($earthquake->getUrl()) . "',
                                  '" . esc_sql($earthquake->getTz()) . "',
                                  '" . esc_sql($earthquake->getUpdated()) . "',
                                  '" . esc_sql($earthquake->getTime()) . "',
                                  '" . esc_sql($earthquake->getPlace()) . "',
                                  '" . esc_sql($earthquake->getMag()) . "',
                        ...
                        $EQInsertRow = $wpdb->query($sqlInsertEQ);
