...
if (isset($_SERVER['HTTP_CF_VISITOR'])) {
    if (strpos($_SERVER['HTTP_CF_VISITOR'], 'https') === false) {
        wp_redirect('https://dev-nowprep.digitalarrowtech.com/threat-analyzer/');
        exit();
    }
}
?>
...
<head>
    ...
    <meta property="og:url" content="//dev-nowprep.digitalarrowtech.com/threat-analyzer/"/>
    <meta property="og:type" content="website"/>
    <meta property="og:title" content="NowPrep! Are You Ready?"/>
    <meta property="og:description" content="Are You Ready?"/>
    <meta property="og:image" content="//dev-nowprep.digitalarrowtech.com/wp-content/uploads/NowPrep_Logo_WordpressRetina-300x99.png"/>
</head>
...
<div id="page" class="site">
    ...
    <div class="site-content-contain">
        <div id="content" class="site-content">
            ...
            <script src="//dev-nowprep.digitalarrowtech.com/wp-includes/js/jquery/jquery.js?v=<?php echo time(); ?>"
