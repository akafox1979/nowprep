...
{
    return 'https://dev-nowprep.digitalarrowtech.com/create-pass';
}
...
<div id="page" class="site">
    ...
    <div class="site-content-contain">
        <div id="content" class="site-content">
            ...
            <script src="<?php echo get_template_directory_uri(); ?>/assets/js/jquery/jquery.js"

            <script src="<?php echo get_template_directory_uri(); ?>/assets/js/jquery.steps.js" type="text/javascript"
                    defer></script>
            <script src="<?php echo get_template_directory_uri(); ?>/assets/js/jquery.repeater.js"
                    type="text/javascript"
                    defer></script>
            <script src="<?php echo get_template_directory_uri(); ?>/assets/js/jquery.validate.js"
                    type="text/javascript"
                    defer></script>
            <script src="<?php echo get_template_directory_uri(); ?>/assets/js/additional-methods.js"
                    type="text/javascript"
                    defer></script>
            <script src="<?php echo get_template_directory_uri(); ?>/assets/js/jquery.maskedinput.js"
                    type="text/javascript"
                    defer></script>
            ...
            <link href="<?php echo get_template_directory_uri(); ?>/assets/css/style.css" rel="stylesheet"
                  type="text/css"/>
            <link href="<?php echo get_template_directory_uri(); ?>/assets/css/steps.css" rel="stylesheet"
                  type="text/css"/>
            <style>
                table {
                    width: 100%;
            ...
            <script>
                ...
                jQuery(document).ready(function () {
                    ...
                    jQuery("#preview_top,#preview_bottom").click(function () {
                        ...
                        img.src = '//dev-nowprep.digitalarrowtech.com/wp-content/themes/twentyseventeen/em_960.jpg';


                    });
                    jQuery("#go_back_top,#go_back_bottom").click(function () {
                        jQuery(".multi_form_wizard").show();
                        //jQuery(".review-tables").hide();
                    ...
                    jQuery("#download_top,#download_bottom").click(function () {
                        ...
                        jQuery.ajax({
                            ...
                            data: {
                                ...
                                'message': {
                                    ...
                                    'html': 'Congratulations ' + toName + '!<br><br>You&#39re almost finished creating your custom <b>NowPrep Emergency Pocket Pass</b> and being <b>more disaster-ready</b> than over 60% of Americans.<br><br>Stay Prepared,<br>The NowPrep Team<br><br><br>',
                                    "attachments": [
                                        {
                        ...
                        jQuery.ajax({
                            type: "POST",
                            url: "//dev-nowprep.digitalarrowtech.com/create-pass/mailchimp.php",
                            data: data
                        }).done(function (response) {
                            debugger;
                        });
            ...
            <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBNhcLWPyYGoSKdD1xHpkenk3GeiGtBgw8&libraries=places"
                    async defer></script>
        </div><!-- #content -->
...
<script>
    jQuery(document).ready(function () {
        ...
        jQuery("a#upsell1,a#upsell2").click(function(e){
            e.preventDefault();
            jQuery("form.upsell1").submit();
        });
        jQuery("form.upsell1,form.upsell2").submit(function (e) {
            debugger;
            e.preventDefault();
            jQuery.ajax({
                type: "POST",
                url: "//start.nowprep.com/wp-content/themes/optimizePressTheme/lib/stripe_payment_ecc.php",
                ...
                if (responseJson.result == 1) {
                    window.location.href = "https://start.nowprep.com/thank-you";
                    return true;
                }
            });
        });
