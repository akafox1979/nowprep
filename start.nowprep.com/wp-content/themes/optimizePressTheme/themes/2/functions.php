...
function theme1_setup() {
    ...
    $theme2ThumbnailSize =  array('width' => 600, 'height' => 300, 'crop' => true);
    $opPostThumbnailSize = apply_filters('opChangePostThumbnailSize', $theme2ThumbnailSize, $theme2ThumbnailSize);
