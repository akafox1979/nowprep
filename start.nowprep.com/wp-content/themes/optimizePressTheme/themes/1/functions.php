...
function theme1_setup() {
    ...
    $theme1ThumbnailSize =  array('width' => 600, 'height' => 300, 'crop' => true);
    $opPostThumbnailSize = apply_filters('opChangePostThumbnailSize', $theme1ThumbnailSize, $theme1ThumbnailSize);
