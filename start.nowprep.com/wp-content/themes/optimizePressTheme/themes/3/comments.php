                ...
                ?>
                	<div class="comments-container">
                        ...
                        <div class="comments-panel tab-content">
                            <ul>
                            <?php wp_list_comments(array('type' => 'comment', 'callback' => 'theme1_comment')); ?>
                            </ul>
                        </div>
                        
                        <div class="trackbacks-panel tab-content" style="display: none;">
                            <ul>
                            <?php wp_list_comments(array('type' => 'pings', 'callback' => 'theme1_comment')); ?>
                            </ul>
                        </div>
                    ...
                    ?>
                    <div id="leave-reply">
                        <h3><?php comment_form_title( __('Leave A Response', 'optimizepress'), __('Leave A Response To %s', 'optimizepress') ); ?> <small><?php cancel_comment_reply_link( __('Cancel reply', 'optimizepress') ); ?></small></h3>
