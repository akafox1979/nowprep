				<div class="older-post-list cf">
					...
					if(has_post_thumbnail()){
						$image = '<a href="'.get_permalink().'" title="'.sprintf( esc_attr__( '%s', 'optimizepress'), the_title_attribute( 'echo=0' ) ).'" rel="bookmark" class="post-image">'.get_the_post_thumbnail( $post->ID ).'</a>';
						$class = '';
					}
					 ?>
