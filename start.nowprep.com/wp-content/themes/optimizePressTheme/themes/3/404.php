            ...
            <div class="main-content content-width cf <?php echo $class ?>">
                <div class="main-content-area-container cf">
                    ...
                    <div class="main-content-area">
                        <p style="padding-top:30px;padding-bottom:10px;"><?php _e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching, or one of the links below, can help.', 'optimizepress'); ?></p>
