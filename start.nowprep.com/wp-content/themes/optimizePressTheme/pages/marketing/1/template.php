...
<head>
    ...
    if ($post->ID == 4766) { ?>
        ...
        <meta property="og:title" content="Prepare for Disaster with Emergency Kit"/>
    ...
    <?php } else if ($post->ID == 3985) { ?>
        ...
        <meta property="og:image:width" content="1500"/>
        <meta property="og:image:height" content="1500"/>
    <?php } else if ($post->ID == 3840 || $post->ID == 3899 || $post->ID == 3954 || $post->ID == 3975  || $post->ID == 3997 || $post->ID == 4055 || $post->ID == 4128 || $post->ID == 4445 || $post->ID == 4460 || $post->ID == 4475 || $post->ID == 4490 || $post->ID == 4579 || $post->ID == 4603) { ?>
