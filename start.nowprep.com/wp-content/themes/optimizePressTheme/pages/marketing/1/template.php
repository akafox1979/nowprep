...
<head>
    ...
    if ($post->ID == 4766) { ?>
        <title>Emergency Kit - Thank You</title>
        <meta property="og:type" content="website"/>
        <meta property="og:url" content="<?php echo "https://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; ?>"/>
        <meta property="og:title" content="NowPrep First-Aid Emergency Kit"/>
        <meta property="og:description"
              content="The Waterproof NowPrep First Aid Kit Includes 48 Professional Grade Items, Individually Packaged For Any Emergency."/>
        <meta property="og:image"
              content="https://start.nowprep.com/wp-content/uploads/pic-3.png"/>
        <meta property="og:image:width" content="1200"/>
        <meta property="og:image:height" content="628"/>
    <?php } else if ($post->ID == 4756 || $post->ID == 4780) { ?>
        ...
        <meta property="og:description"
              content="The Waterproof NowPrep First Aid Kit Includes 48 Professional Grade Items, Individually Packaged For Any Emergency."/>
        <meta property="og:image" content="https://start.nowprep.com/wp-content/uploads/pic-3.png"/>
        <meta property="og:image:width" content="1500"/>
        <meta property="og:image:height" content="1500"/>
    <?php } else if ($post->ID == 4759 || $post->ID == 4740) { ?>
        <title>Emergency Kit - Order Info</title>
        <meta property="og:type" content="website"/>
        <meta property="og:url" content="<?php echo "https://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; ?>"/>
        <meta property="og:title" content="NowPrep First-Aid Emergency Kit"/>
        <meta property="og:description"
    ...
    <?php } else if ($post->ID == 3985) { ?>
        ...
        <meta property="og:image:width" content="1500"/>
        <meta property="og:image:height" content="1500"/>
    <?php } else if ($post->ID == 3840 || $post->ID == 3899 || $post->ID == 3954 || $post->ID == 3975  || $post->ID == 3997 || $post->ID == 4055 || $post->ID == 4128 || $post->ID == 4445 || $post->ID == 4460 || $post->ID == 4475 || $post->ID == 4490 || $post->ID == 4579 || $post->ID == 4603 || $post->ID == 4901 || $post->ID == 4906 || $post->ID == 4949 || $post->ID == 4960 || $post->ID == 4963 ) { ?>
        ...
        <meta property="og:image:width" content="1500"/>
        <meta property="og:image:height" content="1500"/>
    <?php } else if ($post->ID == 3683 || $post->ID == 3719 || $post->ID == 3794 || $post->ID == 3731 || $post->ID == 3480 || $post->ID == 3351 || $post->ID == 3503 || $post->ID == 3833 || $post->ID == 3836 || $post->ID == 3945 || $post->ID == 3948 || $post->ID == 3951 || $post->ID == 4047 || $post->ID == 4222 || $post->ID == 4347 || $post->ID == 4362 || $post->ID == 4385 || $post->ID == 4405 || $post->ID == 4425 || $post->ID == 4897 || $post->ID == 4908 || $post->ID == 4943 || $post->ID == 4954 || $post->ID == 4957 || $post->ID == 5038) { ?>
...
op_footer() ?>
<?php
if($post->ID == 4047 || $post->ID == 4362 || $post->ID == 4385 || $post->ID == 4405 || $post->ID == 4425 || $post->ID == 4906 || $post->ID == 4897 || $post->ID == 4943 || $post->ID == 4954 || $post->ID == 4957 || $post->ID == 5038) {?>
