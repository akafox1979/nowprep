...
<head>
    ...
    <?php } else if ($post->ID == 3840 || $post->ID == 3899 || $post->ID == 3954 || $post->ID == 3975  || $post->ID == 3997 || $post->ID == 4055 || $post->ID == 4128) { ?>
        ...
        <meta property="og:image:width" content="1500"/>
        <meta property="og:image:height" content="1500"/>
    <?php } else if ($post->ID == 3683 || $post->ID == 3719 || $post->ID == 3794 || $post->ID == 3731 || $post->ID == 3480 || $post->ID == 3351 || $post->ID == 3503 || $post->ID == 3833 || $post->ID == 3836 || $post->ID == 3945 || $post->ID == 3948 || $post->ID == 3951 || $post->ID == 4047 || $post->ID == 4222 ) { ?>
