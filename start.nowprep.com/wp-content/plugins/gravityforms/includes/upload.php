	...
	public static function upload() {
		...
		if ( ! empty( $allowed_extensions ) ) {
			if ( ! GFCommon::match_file_extension( $file_name, $allowed_extensions ) || ! GFCommon::match_file_extension( $uploaded_filename, $allowed_extensions ) ) {
				...
				self::die_error( 104, sprintf( __( 'The uploaded file type is not allowed.••G•F•X•F•U•L•L•.•N•E•T•• Must be one of the following: %s', 'gravityforms' ), strtolower( $field['allowedExtensions'] ) ) );
			}
		}
