...
top:a.pageY}))}).on("mouseup",e,function(a){a.currentTarget===a.target&&(tdcWindowFrame._inMoving=!1,tdcWindowFrame.setCurrentWindowFramePosition(a),tdcWindowFrame.setMouseInitialPosition(c),tdcWindowFrame._disableBackground(!1))}).on("mouseup",function(a){tdcWindowFrame._inMoving=!1;tdcWindowFrame._inResizing=!1;tdcWindowFrame.setCurrentWindowFramePosition(a);tdcWindowFrame.setMouseInitialPosition({left:a.pageX,top:a.pageY});tdcWindowFrame._resizeOffset=c;tdcWindowFrame._disableBackground(!1)}).on("mousemove",
function(a){b(this);if(tdcWindowFrame._inMoving){a.stopPropagation();a.preventDefault();var d=tdcWindowFrame.getMouseInitialPosition();if("undefined"!==typeof d){var c=tdcWindowFrame.getCurrentWindowFramePosition();tdcWindowFrame.$_currentWindowFrame.css({left:a.pageX-(d.left-c.left),top:a.pageY-(d.top-c.top)});tdcWindowFrame.$_currentWindowFrame.addClass("clear-position");tdcWindowFrame._disableBackground()}}else if(tdcWindowFrame._inResizing&&(a.stopPropagation(),a.preventDefault(),d=tdcWindowFrame.getMouseInitialPosition(),
"undefined"!==typeof d)){var k={offsetLeft:0,offsetTop:0};_.isUndefined(tdcWindowFrame._resizeOffset)||(k=tdcWindowFrame._resizeOffset);c=tdcWindowFrame.getCurrentWindowFramePosition();d=a.pageX-c.left+k.width-k.offsetLeft;a=a.pageY-c.top+k.height-k.offsetTop;tdcWindowFrame.$_currentWindowFrame.css({width:d,height:a});tdcWindowFrame.$_currentWindowFrame.data("width",d);tdcWindowFrame.$_currentWindowFrame.data("height",a);tdcWindowFrame._timerResize=setTimeout(function(){"undefined"!==typeof tdcWindowFrame._timerResize&&
(clearTimeout(tdcWindowFrame._timerResize),editor.resize(!0))},100);tdcWindowFrame._disableBackground()}}).on("mousedown",f,function(a){if(a.currentTarget===a.target){var d=b(a.currentTarget);tdcWindowFrame.$_currentWindowFrame=b(a.currentTarget).closest("."+tdcWindowFrame._markerCssClass);tdcWindowFrame.setWindowFrame(tdcWindowFrame.$_currentWindowFrame);tdcWindowFrame._inResizing=!0;tdcWindowFrame.setCurrentWindowFramePosition(a);tdcWindowFrame.setMouseInitialPosition({left:a.pageX,top:a.pageY});
tdcWindowFrame._resizeOffset={width:d.width(),height:d.height(),offsetLeft:a.pageX-d.offset().left,offsetTop:a.pageY-d.offset().top}}}).on("mouseup",f,function(a){a.currentTarget===a.target&&(tdcWindowFrame._inResizing=!1,tdcWindowFrame.setMouseInitialPosition(c),tdcWindowFrame._disableBackground(!1),tdcWindowFrame._resizeOffset=c)}).on("click",".tdw-css-writer-expand .tdw-expand-collapse, .tdw-close, .tdc-iframe-close-button",function(a){a.currentTarget===a.target&&(a=b(a.currentTarget).closest(".tdc-window-frame"),
"tdw-css-writer"!==a.attr("id")&&(a.removeClass("clear-position"),a.css({left:"",top:""})),tdcWindowFrame.unsetWindowFrame(a))}).on("mousedown",".tdc-window-frame",function(a){a=b(a.currentTarget);a.hasClass("tdw-inactive")&&tdcWindowFrame.setWindowFrame(a)});tdcWindowFrame.$_window.on("resize",function(){b("."+tdcWindowFrame._markerCssClass).each(function(a,d){var c=b(d),e={},f=c.offset();f.left+100>tdcWindowFrame.$_window.width()&&(e.left=tdcWindowFrame.$_window.width()-100);f.top+100>tdcWindowFrame.$_window.height()&&
(e.top=tdcWindowFrame.$_window.height()-100);b.isEmptyObject(e)||c.css(e)})});tdcWindowFrame._isInitialized=!0}},getCurrentWindowFramePosition:function(){return tdcWindowFrame._currentWindowPosition},setCurrentWindowFramePosition:function(a){tdcWindowFrame._currentWindowPosition="undefined"===typeof tdcWindowFrame.$_currentWindowFrame?c:tdcWindowFrame.$_currentWindowFrame.offset()},setMouseInitialPosition:function(a){tdcWindowFrame._mouseInitialPosition=a},getMouseInitialPosition:function(){return tdcWindowFrame._mouseInitialPosition},
_disableBackground:function(a){"undefined"!==typeof a&&!1===a?tdcWindowFrame.$_tdcIframeCover.removeClass("tdc-iframe-cover-transparent"):tdcWindowFrame.$_tdcIframeCover.addClass("tdc-iframe-cover-transparent")},setWindowFrame:function(a){b("."+tdcWindowFrame._markerCssClass).addClass("tdw-inactive");a.addClass(tdcWindowFrame._markerCssClass);a.css({"z-index":++tdcWindowFrame._lastZIndex});a.removeClass("tdw-inactive")},unsetWindowFrame:function(a){a.removeClass(tdcWindowFrame._markerCssClass);setTimeout(function(){tdcWindowFrame.activeLastWindowFrame()},
...
interval:60,_nonce:window.heartbeatSettings.nonce,action:"heartbeat",screen_id:tdcInit.$postType.val(),has_focus:!1}}).done(function(a,b,c){window.location=tdcInit._url});return!1}};b(window).ready(function(){tdcInit.init()})})(jQuery,_);var tdcDebug;
